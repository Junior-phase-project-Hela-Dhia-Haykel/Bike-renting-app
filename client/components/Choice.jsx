        ...
        return (
            <div>
                ...
                <div className="bike-data">Model</div>
                    ...
                    <div className="bike-data"><input className="input" type='number' defaultValue='0' min='0' max={String(this.props.bike.quantity)} name="quantity" onChange={this.handleEventOnChange}/></div>
